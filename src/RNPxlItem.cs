...
{
    [EntityExport("E6EF42E5-4DAB-4A69-8A93-EC88079F1982",
          EntityName = "RNPxl",
          TableName = "RNPxls",
          DisplayName = "RNPxls",
          Description = "RNPxls",
    ...
    public class RNPxlItem : DynamicEntity
    {
        /// <summary>
        ...
        [EntityProperty(DisplayName = "Abs. prec. error Da")]
        [GridDisplayOptions(VisiblePosition = 10)]
        public double abs_prec_error_da { get; set; }

        [EntityProperty(DisplayName = "Rel. prec. error ppm")]
        [GridDisplayOptions(VisiblePosition = 10)]
        public double rel_prec_error_ppm { get; set; }

        [EntityProperty(DisplayName = "M+H")]
        [GridDisplayOptions(VisiblePosition = 10)]
        public double m_h { get; set; }

        [EntityProperty(DisplayName = "M+2H")]
        [GridDisplayOptions(VisiblePosition = 10)]
        public double m_2h { get; set; }

        [EntityProperty(DisplayName = "M+3H")]
        [GridDisplayOptions(VisiblePosition = 10)]
        public double m_3h { get; set; }

        [EntityProperty(DisplayName = "M+4H")]
        [GridDisplayOptions(VisiblePosition = 10)]
