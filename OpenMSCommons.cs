    ...
    public class OpenMSCommons
    {
        ...
        public static void CreateDefaultINI(string exec_path, string ini_path, string scratch_dir, NodeLoggerErrorDelegate errorLog, NodeLoggerWarningDelegate warnLog)
        {
            ...
            try
            {
                ...
                {
                    errorLog(ex, "The following exception was raised during the execution of \"{0}\":", exec_path);
                    throw;
                }
            ...
            finally
            {
                ...
                {
                    warnLog("The process [{0}] hasn't finished correctly -> forcing the process to exit now", process.StartInfo.FileName);
                    process.Kill();
                }
            }
        }
